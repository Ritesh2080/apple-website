...
const Features = () => {
    ...
    useGSAP(() => {
        ...
        animateWithGsap(".g_text", { scale: 1, opacity: 1, y: 0, ease: "power2.inOut", duration: 1 })
    }, [])
    return (
            ...
            <div className='screen-max-width'>
                ...
                <div className="flex flex-col justify-center items-center overflow-hidden">
                    <div className="mt-32 mb-24 pl-24">
                        ...
                        <h2 className="text-xl lg:text-7xl font-semibold">Forged in titanium.</h2>
                    </div>
                    <div className="flex-center flex-col sm:px-10">
                        <div className="relative h-[50vh] w-full flex items-center">
                            <video className="w-full h-full object-cover object-center" muted autoPlay playsInline id="exploreVideo" ref={videoRef}>
                        ...
                        <div className="feature-text-container items-baseline">
